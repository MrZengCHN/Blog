      ...
      <div class="card-body p-4">
        ...
        <div class="flex items-center gap-3 mb-2">
          <div class="avatar placeholder">
            <div class="bg-neutral text-neutral-content rounded-full w-10 animate-spin-slow flex items-center justify-center" :class="{ 'paused': !isPlaying }">
        ...
        <div class="flex justify-between items-center">
           ...
           <div class="flex items-center gap-2">
             ...
             <button class="btn btn-primary btn-sm btn-circle" @click="togglePlay">
               ...
               <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
             </button>
           ...
           <div class="dropdown dropdown-top dropdown-end">
             ...
             <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 mb-2 max-h-60 overflow-y-auto">
